...
namespace BBG.PictureColoring
{
	public class SelectLevelPopup : Popup
	{
		...
		[SerializeField] private GameObject showRestartButton;
		...
		public void Restart()
        {
			GameObject.Find("GameManager").GetComponent<GameManager>().RestartLevel(GameManager.Instance.Categories[0].levels[Demo02.CurrentLvl]);
			showRestartButton.SetActive(false);
