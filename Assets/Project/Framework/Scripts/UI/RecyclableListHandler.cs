    ...
    public class RecyclableListHandler<T>
    {
        ...
        private void SyncPlaceholdersObjects()
        {
            ...
            while (listItemPlaceholders.Count < dataObjects.Count)
            {
                ...
                GameObject.Find("LibraryScreen").GetComponent<LibraryScreen>().levelObject.Add(placeholder);
            }
        ...
        private void HideListItem(Transform placeHolder)
        {
            //if()
        }
